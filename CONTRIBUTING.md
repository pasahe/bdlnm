...
This outlines how to propose a change to bdlnm. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pasahe/bdlnm", fork = TRUE)`.
...
Please note that the bdlnm project is released with a [Contributor Code
of Conduct](https://pasahe.github.io/bdlnm/CODE_OF_CONDUCT.md). By
