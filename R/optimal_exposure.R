...
#'
#' Armstrong B. (2006). Models for the relationship between ambient temperature and daily mortality. _Epidemiology_, 17(6), 624-631. <doi:10.1097/01.ede.0000239732.50999.8f>.
#'
